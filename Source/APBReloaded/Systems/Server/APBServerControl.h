...
public:
	...
	void InitDistrict(const FString& ResolvedDistrictId);
	void Shutdown();
	...
	bool ReserveLiveDistrict(const FString& PlayerKey, const FString& DistrictId,
		int32 MaxPlayers, FString& OutHost, int32& OutPort, int32& OutNumericId, FString& OutReservationId,
		FString& OutError);
	...
	TArray<FString> ReleaseLiveDistrictReservationsForPlayer(const FString& PlayerKey);
...
private:
	...
	TMap<FString, FString> ReservationByPlayer;
